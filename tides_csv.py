...
for record in data:
    ...
    # The original example wrote tidal data to 'tides.csv'. This repository now removes active
    # tide data writing. If you need to archive tide outputs, re-enable a write block here
    # and ensure the file path and permissions are correct. For now we only print records.
    # (No file write performed.)
    # Example archive code (commented):
    # with open('archived-tides.csv', 'a') as f:
